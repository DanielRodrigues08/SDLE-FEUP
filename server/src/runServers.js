...
const server1 = new Server("localhost", 3000, new Set());
const server2 = new Server("localhost", 3001, new Set());
...
for (let i = 1; i <= 5; i++) {
    await axios.post("http://localhost:3000/addNode", {host: "localhost", port: 4000 + i});
}
